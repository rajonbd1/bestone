...
2. Replace existing config.js and index.html files
3. Push changes to GitHub
4. Done! Your redirect page is live with perfect social media previews.

## Your Configuration:
- Title: ${this.currentConfig.OG_TITLE}
- Redirect to: ${this.currentConfig.REDIRECT_URL}
- Delay: ${this.currentConfig.REDIRECT_DELAY_MS / 1000}s
`;
